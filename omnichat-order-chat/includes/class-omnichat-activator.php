 ...
 * Creates the dedicated omnichat_abandoned_carts database table and default options.
 *
...
class OmniChat_Activator {
	...
	public static function maybe_upgrade() {
		if ( get_option( 'omnichat_db_version' ) !== self::DB_VERSION ) {
			self::create_tables();
			update_option( 'omnichat_db_version', self::DB_VERSION );
		}
	}
	...
	public static function get_default_settings() {
		return array(
			...
			'widget_greeting'        => __( 'Hello! How can we help you today?', 'omnichat-order-chat' ),
			'button_cta_text'        => __( 'Chat with us', 'omnichat-order-chat' ),
			'button_icon'            => 'whatsapp',
			'widget_theme_color'     => '#25D366',
			'popup_header_title'     => __( 'Customer Support', 'omnichat-order-chat' ),
			'popup_header_subtitle'  => __( 'Typically replies within a few minutes', 'omnichat-order-chat' ),
			'sending_mode'           => 'direct',
			'meta_api_token'         => '',
			...
			'enable_ga4_tracking'    => 'yes',
			'enable_fb_tracking'     => 'yes',
			'enable_woo_order_btn'   => 'yes',
			'woo_btn_text'           => __( 'Order via WhatsApp', 'omnichat-order-chat' ),
			...
			'agents'                 => array(
				array(
					'name'        => 'Sarah Jenkins',
					'role'        => __( 'Sales & Orders', 'omnichat-order-chat' ),
					'channel'     => 'whatsapp',
					'phone'       => '+15551234567',
					'hours_start' => '09:00',
					'hours_end'   => '18:00',
				...
				array(
					'name'        => 'David Chen',
					'role'        => __( 'Technical Support', 'omnichat-order-chat' ),
					'channel'     => 'whatsapp',
					'phone'       => '+15559876543',
					'hours_start' => '08:00',
					'hours_end'   => '20:00',
	...
	public static function set_default_options() {
		if ( false === get_option( 'omnichat_settings', false ) ) {
			add_option( 'omnichat_settings', self::get_default_settings() );
		}
	}
}
